...
@section('content')
<section class="bg-gradient-to-b from-[#dff3ea] to-[#faf8f6] min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-4xl w-full space-y-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition">
        <div class="text-2xl text-[#ffb347] mb-2">📞</div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition">
        <div class="text-2xl text-[#ffb347] mb-2">✉️</div>
      ...
      <form action="#" method="POST" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" name="first_name" placeholder="First Name" required
                 class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffb347]">
        ...
        <textarea name="message" rows="5" placeholder="Your Message" required
                  class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffb347]"></textarea>
        <button type="submit" class="w-full bg-[#ffb347] hover:bg-[#ffaa00] text-white font-bold py-3 rounded-lg transition">
          Send Message
        </button>
      </form>
    </div>
